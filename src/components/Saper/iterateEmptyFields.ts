import { Field, OnButtonClickAction, PlayAreaSize, SetHydratedFields } from '../../types'
...
const clickAboveAndUnderButton = (
  ...
  if (tempField && tempField.bombsInTouch > 0) {
    const coordinatesOfSurroundingFields = getCoordinatesOfSurroundingFields(tempField)
    const coordinatesToClick = [coordinatesOfSurroundingFields[3], coordinatesOfSurroundingFields[6]]
...
export const loopFunction = (
  ...
  const getTempFieldCondition = (dir: 'left' | 'right' | 'up' | 'down', tempField: Field) => {
    switch (dir) {
      case 'left':
  ...
  do {
    tempField = getFieldID(
      dir === 'up' ? tempField.x - 1 : dir === 'down' ? tempField.x + 1 : tempField.x,
      dir === 'left' ? tempField.y - 1 : dir === 'right' ? tempField.y + 1 : tempField.y,
      hydratedFields
    )
    tempField && onButtonClickAction(tempField.id, hydratedFields, setHydratedFields)
    clickAboveAndUnderButton(tempField, onButtonClickAction, hydratedFields, setHydratedFields)
  } while (
    tempField &&
...
export const iterateEmptyFields = (
  ...
  do {
    ...
    do {
      //**w lewo */
      loopFunction(fieldAboveGoingLeft, 'left', playAreaSize, hydratedFields, setHydratedFields, onButtonClickAction)
      //** w prawo */
      loopFunction(fieldAboveGoingLeft, 'right', playAreaSize, hydratedFields, setHydratedFields, onButtonClickAction)
    ...
    do {
      //**w lewo */
      loopFunction(fieldUnderGoingRLeft, 'left', playAreaSize, hydratedFields, setHydratedFields, onButtonClickAction)
      //** w prawo */
      loopFunction(fieldUnderGoingRLeft, 'right', playAreaSize, hydratedFields, setHydratedFields, onButtonClickAction)
    ...
    clickAboveAndUnderButton(tempFieldBack, onButtonClickAction, hydratedFields, setHydratedFields)
  } while (
    tempFieldBack &&
    tempFieldBack.y >= 1 &&
  ...
  do {
    ...
    do {
      //**w lewo */
      loopFunction(fieldAboveGoingRight, 'left', playAreaSize, hydratedFields, setHydratedFields, onButtonClickAction)
      //** w prawo */
      loopFunction(fieldAboveGoingRight, 'right', playAreaSize, hydratedFields, setHydratedFields, onButtonClickAction)
    ...
    do {
      //**w lewo */
      loopFunction(fieldUnderGoingRight, 'left', playAreaSize, hydratedFields, setHydratedFields, onButtonClickAction)
      //** w prawo */
      loopFunction(fieldUnderGoingRight, 'right', playAreaSize, hydratedFields, setHydratedFields, onButtonClickAction)
    ...
    clickAboveAndUnderButton(tempFieldForward, onButtonClickAction, hydratedFields, setHydratedFields)
  } while (
    tempFieldForward &&
